...
> ⚠️ **CORS for HTML lessons**: Firebase Storage allows iframe loads by default, but if you hit CORS issues, configure CORS using the [gsutil tool](https://firebase.google.com/docs/storage/web/download-files#cors_configuration).
