...
const GeneralPage = () => {
  ...
  const [subsection, setSubsection] = useState(null); // null = show categories
  ...
  // Reset search when changing subsection
  useEffect(() => {
    setSearch('');
  }, [subsection]);
    ...
    <PageTransition className="max-w-7xl mx-auto px-4 py-10">
      ...
      {loading ? (
        ...
        <AnimatePresence mode="wait">
          ...
          {/* ============ View 2: Show lessons of selected subsection ============ */}
          {subsection && (
            <motion.div
